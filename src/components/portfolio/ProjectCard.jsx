    ...
    <div className="group relative flex flex-col justify-between h-full bg-zinc-900/60 border border-zinc-800/80 hover:border-zinc-700 rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-lg">
        ...
        <div className="p-5 space-y-3">
          ...
          <div className="flex flex-wrap gap-1.5 pt-2 border-t border-zinc-800/60">
            {techList.map((t) => (
              <span
                key={t}
                className="text-[10px] font-mono text-zinc-300 bg-zinc-800/80 px-2 py-0.5 rounded border border-zinc-700/50"
              >
                {t}
              </span>
            ))}
      ...
      <div className="p-5 pt-0 flex items-center justify-between gap-2">
        <button
          ...
          className="flex-1 inline-flex items-center justify-center gap-1.5 py-2 px-3 rounded-lg text-xs font-mono font-medium text-zinc-200 bg-zinc-800 hover:bg-zinc-700 border border-zinc-700 hover:border-zinc-600 transition-all cursor-pointer"
        >
        ...
        {project.github && (
          <a
            ...
            className="p-2 rounded-lg bg-zinc-800 text-zinc-400 hover:text-white border border-zinc-700 hover:border-zinc-600 transition-colors flex items-center justify-center"
